...
3. Ora possiamo eseguire `parser.py`
   ...
   > Vedremo come fare ciò in un prossimo paragrafo, per ora mi limiterò a dire che utilizzeremo un interessante utility: [`pzb`](https://github.com/tihmstar/partialZipBrowser).<br/>
   > Ciò è possibile perché gli ZIP permettono l'[accesso casuale](https://en.wikipedia.org/w/index.php?title=ZIP_(file_format)&oldid=1143183309#Design). 
